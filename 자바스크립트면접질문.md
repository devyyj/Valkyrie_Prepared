...
반면에 프로토타입은 클래스와 달리 ES6 이전부터 사용되던 개념입니다. 프로토타입은 상속을 구현하기 위해 사용되며, 자바스크립트에서 모든 객체는 프로토타입을 가지고 있습니다. 프로토타입은 객체를 생성하는 함수에서
...
방식이며, 상속 구현에 있어서는 더 자유롭고 유연한 방법을 제공합니다.
